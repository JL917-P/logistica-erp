...
function Internacional({ onAnalysisComplete, onError, onLoading, loading, analysisData }) {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Carga y analiza archivos Excel internacionales
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 p-4 bg-teal-50 border border-teal-200 rounded-lg">
            <p className="text-sm text-teal-800">
              <strong>Instrucciones:</strong> Arrastra un archivo Excel con información internacional. 
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Resultados del archivo internacional procesado
                </p>
              </div>
            </div>
            <button
